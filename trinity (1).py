...
class menu:
    ...
    def __init__(self):
       ...
       # self.root.state('zoomed')
        ...
        l1 = Button(self.a, text='BOOK DATA', font='Papyrus 22 bold', fg='black', bg='yellow', width=19, padx=10, borderwidth=0, command=self.book).place(x=80, y=500)
        l2 = Button(self.a, text='STUDENT DATA', font='Papyrus 22 bold', fg='black', bg='yellow', width=18, padx=10, borderwidth=0, command=self.student).place(x=600, y=500)
        self.root.mainloop()
    ...
    def book(self):
        ...
        l3 = Button(self.a, text='All Books', font='Papyrus 22 bold', fg='black', bg='yellow', width=15, padx=10, command=self.all).place(x=12, y=300)
...
#==============================LABELS=========================================
lbl_title = Label(canvas, text="MEMBERS  LOGIN :", font=('Papyrus', 30, 'bold', ), bg='white', fg='black')
